...
url = 'https://maps.googleapis.com/maps/api/place/nearbysearch/json?location='+coordinates+'&radius='+str(radius)+'&keyword='+str(keywords)+'&key='+str(api_key)
...
while True:
    ...
    if 'next_page_token' not in j or count == 25: 
        break
    else:
